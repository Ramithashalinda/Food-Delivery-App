...
public static int imgV;
    ...
    public void onBindViewHolder(@NonNull PopularFoodViewHolder holder, int position) {
        ...
        final String name = popularFoodList.get(position).getName();
        final int img = popularFoodList.get(position).getImageUrl();
        final  String price = popularFoodList.get(position).getPrice();
